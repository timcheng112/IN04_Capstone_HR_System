...
//   function callNFC(){
//     api.callNFC().then((response) => console.log(response.data)).catch((error) => {
//                 console.log(error.response)
//              });
//   }

  function callNFC(){
    // axios.get(`http://localhost:9191/api/attendance/nfc`).then((response) => console.log(response.data));
    // console.log(a);
    // api.getAllEmployees().then((response) => console.log(response.data));
    api.callNFC().then((response) => console.log(response.data)).catch((error) => {
                        console.log(error.response)
                     });
  }
