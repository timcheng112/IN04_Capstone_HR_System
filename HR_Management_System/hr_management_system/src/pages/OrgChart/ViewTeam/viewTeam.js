...
const people = [
  {
    name: 'Samuel Ng',
    position: 'Runner',
    department: 'NTU Track',
    email: 'samngrys@example.com',
    role: 'Manager',
    image:
      'https://media-exp1.licdn.com/dms/image/C4E03AQFUW384FVUB2Q/profile-displayphoto-shrink_200_200/0/1657076129657?e=1667433600&v=beta&t=xje_RRAyBK0LJl4He0AY5gvrAIUb0ZMkRjzxCfKlEII',
  },
  // More people...
  {
    name: 'Wong Shi Han',
    position: 'Outside Hitter',
    department: 'NUS Recre VBC',
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-xl font-semibold text-gray-900">Seng Kang Outlet</h1>
          <p className="mt-2 text-sm text-gray-700">
            A list of all employees of the Seng Kang Outlet including their name, title, email and role.
          </p>
        </div>
                    ...
                    <tr key={person.email}>
                      ...
                      <td className="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                        <a href="#" className="text-indigo-600 hover:text-indigo-900">
                          Move An Employee<span className="sr-only">, {person.name}</span>
                        </a>
                      </td>
                    </tr>
                  ))}
