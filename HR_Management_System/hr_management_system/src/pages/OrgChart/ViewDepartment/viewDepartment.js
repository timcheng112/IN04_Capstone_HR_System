...
const teams = [
  { name: 'Seng Kang Outlet', outlet: 'Compass One', teamLeader: 'Linsay Walton', position: 'Manager' },
  { name: 'Bishan Outlet', outlet: 'Junction 8', teamLeader: 'Timothy Wango', position: 'Manager' },
  // More team...
]
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-xl font-semibold text-gray-900">Sales Department</h1>
          <p className="mt-2 text-sm text-gray-700">
            A list of all the teams in the Sales Department including their name, outlet and supervisor.
          </p>
        </div>
                ...
                <tbody className="bg-white">
                  {teams.map((team, teamIdx) => (
                    <tr key={team.email} className={teamIdx % 2 === 0 ? undefined : 'bg-gray-50'}>
                      ...
                      <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{team.outlet}</td>
