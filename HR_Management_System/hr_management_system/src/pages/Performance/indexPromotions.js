...
import AddPromotionRequestModal from "../../features/performance/AddPromotionRequestModal";
import Steps from "../../components/Steps";

const tabs = [
  { name: "Promotion Request", href: "/promotions/", current: true },
  { name: "All Promotions", href: "/career/promotions", current: false },
];

export default function PromotionRequestIndex() {
  ...
  return (
    <div className="">
      ...
      <AddPromotionRequestModal
        open={openAddPromotion}
        onClose={() => setOpenAddPromotion(false)}
      />
        ...
        <div className="sm:flex sm:items-center space-x-4">
          ...
          <div className="mt-4 sm:mt-0 sm:ml-16 sm:flex-none">
            <button
              ...
              // onClick={() => history.push("/promotion/newPromotionRequest")}
