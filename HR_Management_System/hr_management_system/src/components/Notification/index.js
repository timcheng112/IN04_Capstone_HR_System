...
//     const onClick = () => toast({title: "hi", content:"please noooooooooooooooooooooooooooooo"},{ hideProgressBar: false , autoClose: 5000, type: 'info' })
      ...
      >
        <div className="flex w-full flex-col items-center space-y-4 sm:items-end">
          ...
          <Transition
            ...
            enterFrom="translate-y-10 opacity-0 sm:translate-y-0 sm:translate-x-2"
