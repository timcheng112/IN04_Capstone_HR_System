...
import ProgressionBreadcrumb from "../Breadcrumb/ProgressionBreadcrumb";

const navigationhr = [
  { name: "Promotion", href: "/career/promotion", icon: UsersIcon, current: false },
  { name: "Transfer", href: "/career/transfer", icon: FolderIcon, current: false },
];
const navigation = [
  { name: "Promotion", href: "/career/promotion", icon: UsersIcon, current: false },
  { name: "Transfer", href: "/career/transfer", icon: FolderIcon, current: false },
...
export default function ProgressionSidebar({ currentPage }) {
