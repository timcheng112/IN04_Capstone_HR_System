...
export default function AddUserByGroupingsRadioGroup({
  ...
  //   new Array(options.length).fill({ indexChecked: [] })
  // );
  ...
  const handleOnChange = (position) => {
    ...
    //     return {
    //       indexChecked: [
    //         ...obj.indexChecked.slice(0, position),
    //         !obj.indexChecked[position],
    //         ...obj.indexChecked.slice(position + 1, obj.indexChecked.length),
    //       ],
    //     };
    //   }
    //   return obj;
