...
import AssignPlanToEmployee from "./AssignPlanToEmployee";

export default function AssignBenefit({
  open,
  onClose,
  plan,
}) {
  ...
  useEffect(() => {
    ...
    api.getEmployeesUnassignedToPlan(plan.benefitPlanId).then((response) => {
  ...
  function assignPlan() {
    ...
    assignedEmployees
      .forEach((employee) => {
        api
          .addBenefitPlanInstance(plan.benefitPlanId, employee.userId)
          .then(() => alert("Successfully assigned."))
  ...
  function assignEmployeeToPlan(employee) {
  ...
  function removeEmployeeFromPlan(employee) {
    setAssignedEmployees(
              ...
              <Dialog.Panel className="bg-white relative transform overflow-hidden rounded-lg text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div className="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                  <div className="mt-3 text-center sm:mt-0 sm:text-left">
                    ...
                    >
                      Assign Benefit Plan to Employees
                    </Dialog.Title>
                    ...
                    <div className="flex space-x-4 w-full justify-between ">
                      ...
                      <div className="overflow-y-scroll w-full border-2 rounded-md">
                        ...
                        <AssignPlanToEmployee
                          ...
                          onClick={removeEmployeeFromPlan}
                        />
                      </div>
                    </div>
                  </div>
